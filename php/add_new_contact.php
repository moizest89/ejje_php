...
if ($validate === true && mysql_query(
    ...
    "INSERT INTO contacts (name_user, email_user, appoiment_user, company_user, email_sugestion1, email_sugestion2, email_sugestion3)
    VALUE('{$name_user}','{$email_user}','{$appoiment_user}','{$company_user}','{$email_sugestion1}','{$email_sugestion2}','{$email_sugestion3}')"
)) {
